"""
Django settings for panchkarma_setu project.
...
ROOT_URLCONF = 'panchkarma_setu.urls'
...
WSGI_APPLICATION = 'panchkarma_setu.wsgi.application'
...
# Email Configuration - Update these with real SMTP credentials to receive real emails
